...
public class MenuView {
	...
	public static void update(User user) {
		...
		while (true) {
			System.out.println("1. 비밀번호 변경  2. 전화번호 변경  3. 변경 완료하기 (3번 누를때까지 반복)");
			System.out.print("번호 선택 > ");
	 ...
	 * 
	 * MenuView.printSubMenu(); int menu = Integer.parseInt(sc.nextLine());
	 * switch(menu) { case 1 : MenuView.update(); break; case 2 : MenuView.delete();
	 * //삭제 break; case 9 : MenuView.printMenu(); } //System.out.print("2. 탈퇴 ");
